...
const footerLinks = {
  'Producto': [
    ...
    { name: 'Dispositivos', href: '/dashboard' },
    { name: 'Análisis', href: '/dashboard' },
  ],
  'Comunidad': [
    { name: 'Ranking', href: '/comunidad' },
    { name: 'Retos', href: '/retos' },
    { name: 'Foro', href: '/comunidad' },
  ],
  'Recursos': [
    { name: 'Educación', href: '/educacion' },
    { name: 'Blog', href: '/educacion' },
    { name: 'Documentación', href: '/educacion' },
  ],
  'Soporte': [
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-sm max-w-md">
              {APP_CONFIG.description}. Únete a la comunidad de energía inteligente 
              y optimiza tu consumo mientras contribuyes a un futuro más sostenible.
            </p>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2025 {APP_CONFIG.name}. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
